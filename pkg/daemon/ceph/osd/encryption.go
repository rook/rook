...
// If the error, received from the luksChangeKey cmd, shows that the key did not match,
// the function will return false and no error, to signify that the given key is not in the slot.
