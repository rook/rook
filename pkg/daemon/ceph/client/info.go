...
type ClusterInfo struct {
	...
	// A context to cancel. It is used to determine whether the reconcile loop should
	// exit (if the context has been cancelled). This cannot be in main clusterd context since this
