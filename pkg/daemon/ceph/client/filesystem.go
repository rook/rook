...
// SetAllowStandbyReplay sets the allow_standby_replay for a Ceph filesystem.
func SetAllowStandbyReplay(context *clusterd.Context, clusterInfo *ClusterInfo, fsName string, allowStandbyReplay bool) error {
...
// SetStandbyCountWanted sets the standby_count_wanted for a Ceph filesystem.
func SetStandbyCountWanted(context *clusterd.Context, clusterInfo *ClusterInfo, fsName string, wantedStandbyDaemons int32) error {
	logger.Infof("setting standby_count_wanted to %d for filesystem %q", wantedStandbyDaemons, fsName)
