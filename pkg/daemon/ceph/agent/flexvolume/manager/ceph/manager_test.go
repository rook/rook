...
func TestInitLoadRBDModSingleMajor(t *testing.T) {
	...
	executor := &exectest.MockExecutor{
		...
		MockExecuteCommand: func(debug bool, command string, args ...string) error {
...
func TestAttach(t *testing.T) {
	...
	executor := &exectest.MockExecutor{
		...
		MockExecuteCommandWithTimeout: func(debug bool, timeout time.Duration, command string, args ...string) (string, error) {
