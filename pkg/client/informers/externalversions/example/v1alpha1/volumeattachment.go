...
import (
	...
	v1alpha1 "github.com/rook/rook/pkg/client/listers/example/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.ExampleV1alpha1().VolumeAttachments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.ExampleV1alpha1().VolumeAttachments(namespace).Watch(options)
			},
		},
