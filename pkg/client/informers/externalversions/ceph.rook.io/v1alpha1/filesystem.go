...
import (
	...
	v1alpha1 "github.com/rook/rook/pkg/client/listers/ceph.rook.io/v1alpha1"
...
func (f *filesystemInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cephrookiov1alpha1.Filesystem{}, f.defaultInformer)
}
