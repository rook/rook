...
import (
	rook_io_v1alpha2 "github.com/rook/rook/pkg/apis/rook.io/v1alpha2"
	...
	v1alpha2 "github.com/rook/rook/pkg/client/listers/rook/v1alpha2"
...
func NewVolumeInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&rook_io_v1alpha2.Volume{},
		resyncPeriod,
		indexers,
	)
}

func defaultVolumeInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewVolumeInformer(client, v1.NamespaceAll, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc})
}

func (f *volumeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rook_io_v1alpha2.Volume{}, defaultVolumeInformer)
}
