	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.RookV1alpha1().ObjectStores(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.RookV1alpha1().ObjectStores(namespace).Watch(options)
			},
		},
		&rook_io_v1alpha1.ObjectStore{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *objectStoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rook_io_v1alpha1.ObjectStore{}, defaultObjectStoreInformer)
}
