...
import (
	...
	v1alpha1 "github.com/rook/rook/pkg/client/listers/rook.io/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RookV1alpha1().Filesystems(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RookV1alpha1().Filesystems(namespace).Watch(options)
			},
		},
		&rookiov1alpha1.Filesystem{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *filesystemInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rookiov1alpha1.Filesystem{}, f.defaultInformer)
}
