	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RookV1alpha1().Pools(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RookV1alpha1().Pools(namespace).Watch(options)
			},
		},
		&rookiov1alpha1.Pool{},
		resyncPeriod,
...
func (f *poolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rookiov1alpha1.Pool{}, f.defaultInformer)
}
