...
import (
	...
	v1alpha1 "github.com/rook/rook/pkg/client/listers/minio/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.MinioV1alpha1().ObjectStores(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.MinioV1alpha1().ObjectStores(namespace).Watch(options)
			},
		},
		&minio_rook_io_v1alpha1.ObjectStore{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *objectStoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&minio_rook_io_v1alpha1.ObjectStore{}, defaultObjectStoreInformer)
}
