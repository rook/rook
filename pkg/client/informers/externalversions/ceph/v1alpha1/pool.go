	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.CephV1alpha1().Pools(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.CephV1alpha1().Pools(namespace).Watch(options)
			},
		},
		&ceph_rook_io_v1alpha1.Pool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *poolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ceph_rook_io_v1alpha1.Pool{}, defaultPoolInformer)
}
