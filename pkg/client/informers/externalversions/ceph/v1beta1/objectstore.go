	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.CephV1beta1().ObjectStores(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.CephV1beta1().ObjectStores(namespace).Watch(options)
			},
		},
		&ceph_rook_io_v1beta1.ObjectStore{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *objectStoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ceph_rook_io_v1beta1.ObjectStore{}, defaultObjectStoreInformer)
}

func (f *objectStoreInformer) Lister() v1beta1.ObjectStoreLister {
	return v1beta1.NewObjectStoreLister(f.Informer().GetIndexer())
}
