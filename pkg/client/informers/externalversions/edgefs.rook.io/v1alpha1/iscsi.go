	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EdgefsV1alpha1().ISCSIs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EdgefsV1alpha1().ISCSIs(namespace).Watch(options)
			},
		},
		&edgefsrookiov1alpha1.ISCSI{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *iSCSIInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&edgefsrookiov1alpha1.ISCSI{}, f.defaultInformer)
}

func (f *iSCSIInformer) Lister() v1alpha1.ISCSILister {
	return v1alpha1.NewISCSILister(f.Informer().GetIndexer())
}
