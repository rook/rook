	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EdgefsV1alpha1().ISGWs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EdgefsV1alpha1().ISGWs(namespace).Watch(options)
			},
		},
		&edgefsrookiov1alpha1.ISGW{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *iSGWInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&edgefsrookiov1alpha1.ISGW{}, f.defaultInformer)
}

func (f *iSGWInformer) Lister() v1alpha1.ISGWLister {
	return v1alpha1.NewISGWLister(f.Informer().GetIndexer())
}
