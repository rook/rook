...
type SWIFTLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.SWIFT, err error)
...
// List lists all SWIFTs in the indexer.
func (s *sWIFTLister) List(selector labels.Selector) (ret []*v1alpha1.SWIFT, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.SWIFT))
	})
	return ret, err
}
...
type SWIFTNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.SWIFT, error)
...
// List lists all SWIFTs in the indexer for a given namespace.
func (s sWIFTNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.SWIFT, err error) {
...
// Get retrieves the SWIFT from the indexer for a given namespace and name.
func (s sWIFTNamespaceLister) Get(name string) (*v1alpha1.SWIFT, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("swift"), name)
	}
	return obj.(*v1alpha1.SWIFT), nil
}
