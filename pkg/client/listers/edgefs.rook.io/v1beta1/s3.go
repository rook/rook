...
type S3Lister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.S3, err error)
...
// List lists all S3s in the indexer.
func (s *s3Lister) List(selector labels.Selector) (ret []*v1beta1.S3, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.S3))
	})
	return ret, err
}
...
type S3NamespaceLister interface {
	...
	Get(name string) (*v1beta1.S3, error)
...
// List lists all S3s in the indexer for a given namespace.
func (s s3NamespaceLister) List(selector labels.Selector) (ret []*v1beta1.S3, err error) {
...
// Get retrieves the S3 from the indexer for a given namespace and name.
func (s s3NamespaceLister) Get(name string) (*v1beta1.S3, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("s3"), name)
	}
	return obj.(*v1beta1.S3), nil
}
