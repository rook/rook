...
type S3XLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.S3X, err error)
...
// List lists all S3Xs in the indexer.
func (s *s3XLister) List(selector labels.Selector) (ret []*v1beta1.S3X, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.S3X))
	})
	return ret, err
}
...
type S3XNamespaceLister interface {
	...
	Get(name string) (*v1beta1.S3X, error)
...
// List lists all S3Xs in the indexer for a given namespace.
func (s s3XNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.S3X, err error) {
...
// Get retrieves the S3X from the indexer for a given namespace and name.
func (s s3XNamespaceLister) Get(name string) (*v1beta1.S3X, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("s3x"), name)
	}
	return obj.(*v1beta1.S3X), nil
}
