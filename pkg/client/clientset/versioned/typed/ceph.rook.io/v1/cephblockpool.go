...
<<<<<<< HEAD
	*gentype.ClientWithList[*v1.CephBlockPool, *v1.CephBlockPoolList]
=======
...
<<<<<<< HEAD
		gentype.NewClientWithList[*v1.CephBlockPool, *v1.CephBlockPoolList](
			"cephblockpools",
			c.RESTClient(),
...
func (c *cephBlockPools) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.CephBlockPool, err error) {
...
func (c *cephBlockPools) List(ctx context.Context, opts metav1.ListOptions) (result *v1.CephBlockPoolList, err error) {
...
func (c *cephBlockPools) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cephBlockPools) Create(ctx context.Context, cephBlockPool *v1.CephBlockPool, opts metav1.CreateOptions) (result *v1.CephBlockPool, err error) {
	result = &v1.CephBlockPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cephblockpools").
...
func (c *cephBlockPools) Update(ctx context.Context, cephBlockPool *v1.CephBlockPool, opts metav1.UpdateOptions) (result *v1.CephBlockPool, err error) {
	result = &v1.CephBlockPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cephblockpools").
...
func (c *cephBlockPools) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *cephBlockPools) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cephBlockPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.CephBlockPool, err error) {
	result = &v1.CephBlockPool{}
