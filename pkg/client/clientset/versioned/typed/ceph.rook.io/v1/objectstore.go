...
type ObjectStoreInterface interface {
	Create(*v1.ObjectStore) (*v1.ObjectStore, error)
	Update(*v1.ObjectStore) (*v1.ObjectStore, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.ObjectStore, error)
	List(opts metav1.ListOptions) (*v1.ObjectStoreList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.ObjectStore, err error)
...
func newObjectStores(c *CephV1Client, namespace string) *objectStores {
	return &objectStores{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *objectStores) Get(name string, options metav1.GetOptions) (result *v1.ObjectStore, err error) {
	result = &v1.ObjectStore{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *objectStores) List(opts metav1.ListOptions) (result *v1.ObjectStoreList, err error) {
	result = &v1.ObjectStoreList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("objectstores").
...
func (c *objectStores) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("objectstores").
...
func (c *objectStores) Create(objectStore *v1.ObjectStore) (result *v1.ObjectStore, err error) {
	result = &v1.ObjectStore{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("objectstores").
...
func (c *objectStores) Update(objectStore *v1.ObjectStore) (result *v1.ObjectStore, err error) {
	result = &v1.ObjectStore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectstores").
...
func (c *objectStores) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *objectStores) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("objectstores").
...
func (c *objectStores) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.ObjectStore, err error) {
	result = &v1.ObjectStore{}
