...
var clustersResource = schema.GroupVersionResource{Group: "cassandra.rook.io", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "cassandra.rook.io", Version: "v1alpha1", Kind: "Cluster"}
