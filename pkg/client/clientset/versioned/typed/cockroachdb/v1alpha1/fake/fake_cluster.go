...
type FakeClusters struct {
	Fake *FakeCockroachdbV1alpha1
	ns   string
}

var clustersResource = schema.GroupVersionResource{Group: "cockroachdb.rook.io", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "cockroachdb.rook.io", Version: "v1alpha1", Kind: "Cluster"}
