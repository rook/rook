...
func NewForConfig(c *rest.Config) (*EdgefsV1alpha1Client, error) {
	...
	return &EdgefsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EdgefsV1alpha1Client for the given config and
...
func New(c rest.Interface) *EdgefsV1alpha1Client {
	return &EdgefsV1alpha1Client{c}
}
