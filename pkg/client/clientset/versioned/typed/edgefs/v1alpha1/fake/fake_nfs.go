...
var nfssResource = schema.GroupVersionResource{Group: "edgefs.rook.io", Version: "v1alpha1", Resource: "nfss"}

var nfssKind = schema.GroupVersionKind{Group: "edgefs.rook.io", Version: "v1alpha1", Kind: "NFS"}
...
func (c *FakeNFSs) Get(name string, options v1.GetOptions) (result *v1alpha1.NFS, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(nfssResource, c.ns, name), &v1alpha1.NFS{})
...
func (c *FakeNFSs) List(opts v1.ListOptions) (result *v1alpha1.NFSList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(nfssResource, nfssKind, c.ns, opts), &v1alpha1.NFSList{})
...
func (c *FakeNFSs) Create(nFS *v1alpha1.NFS) (result *v1alpha1.NFS, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(nfssResource, c.ns, nFS), &v1alpha1.NFS{})
...
func (c *FakeNFSs) Update(nFS *v1alpha1.NFS) (result *v1alpha1.NFS, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(nfssResource, c.ns, nFS), &v1alpha1.NFS{})
...
func (c *FakeNFSs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(nfssResource, c.ns, name), &v1alpha1.NFS{})
...
func (c *FakeNFSs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.NFS, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(nfssResource, c.ns, name, data, subresources...), &v1alpha1.NFS{})
