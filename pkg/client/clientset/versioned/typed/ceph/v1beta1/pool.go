...
type PoolInterface interface {
	Create(*v1beta1.Pool) (*v1beta1.Pool, error)
	Update(*v1beta1.Pool) (*v1beta1.Pool, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.Pool, error)
	List(opts v1.ListOptions) (*v1beta1.PoolList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Pool, err error)
	PoolExpansion
}
...
func newPools(c *CephV1beta1Client, namespace string) *pools {
	return &pools{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pools) Get(name string, options v1.GetOptions) (result *v1beta1.Pool, err error) {
	result = &v1beta1.Pool{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pools").
...
func (c *pools) List(opts v1.ListOptions) (result *v1beta1.PoolList, err error) {
	result = &v1beta1.PoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pools").
...
func (c *pools) Create(pool *v1beta1.Pool) (result *v1beta1.Pool, err error) {
	result = &v1beta1.Pool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pools").
...
func (c *pools) Update(pool *v1beta1.Pool) (result *v1beta1.Pool, err error) {
	result = &v1beta1.Pool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pools").
...
func (c *pools) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Pool, err error) {
	result = &v1beta1.Pool{}
