...
var poolsResource = schema.GroupVersionResource{Group: "ceph.rook.io", Version: "v1beta1", Resource: "pools"}

var poolsKind = schema.GroupVersionKind{Group: "ceph.rook.io", Version: "v1beta1", Kind: "Pool"}
...
func (c *FakePools) Get(name string, options v1.GetOptions) (result *v1beta1.Pool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(poolsResource, c.ns, name), &v1beta1.Pool{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Pool), err
}
...
func (c *FakePools) List(opts v1.ListOptions) (result *v1beta1.PoolList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(poolsResource, poolsKind, c.ns, opts), &v1beta1.PoolList{})
	...
	list := &v1beta1.PoolList{}
	for _, item := range obj.(*v1beta1.PoolList).Items {
...
func (c *FakePools) Create(pool *v1beta1.Pool) (result *v1beta1.Pool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(poolsResource, c.ns, pool), &v1beta1.Pool{})
...
func (c *FakePools) Update(pool *v1beta1.Pool) (result *v1beta1.Pool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(poolsResource, c.ns, pool), &v1beta1.Pool{})
...
func (c *FakePools) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(poolsResource, c.ns, name), &v1beta1.Pool{})
...
func (c *FakePools) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.PoolList{})
	return err
}
