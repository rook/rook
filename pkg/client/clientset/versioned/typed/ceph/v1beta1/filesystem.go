...
type FilesystemInterface interface {
	Create(*v1beta1.Filesystem) (*v1beta1.Filesystem, error)
	Update(*v1beta1.Filesystem) (*v1beta1.Filesystem, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.Filesystem, error)
	List(opts v1.ListOptions) (*v1beta1.FilesystemList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Filesystem, err error)
	FilesystemExpansion
}
...
func newFilesystems(c *CephV1beta1Client, namespace string) *filesystems {
	return &filesystems{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *filesystems) Get(name string, options v1.GetOptions) (result *v1beta1.Filesystem, err error) {
	result = &v1beta1.Filesystem{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *filesystems) List(opts v1.ListOptions) (result *v1beta1.FilesystemList, err error) {
	result = &v1beta1.FilesystemList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("filesystems").
...
func (c *filesystems) Create(filesystem *v1beta1.Filesystem) (result *v1beta1.Filesystem, err error) {
	result = &v1beta1.Filesystem{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("filesystems").
...
func (c *filesystems) Update(filesystem *v1beta1.Filesystem) (result *v1beta1.Filesystem, err error) {
	result = &v1beta1.Filesystem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("filesystems").
...
func (c *filesystems) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Filesystem, err error) {
	result = &v1beta1.Filesystem{}
