...
type ObjectStoreInterface interface {
	Create(*v1beta1.ObjectStore) (*v1beta1.ObjectStore, error)
	Update(*v1beta1.ObjectStore) (*v1beta1.ObjectStore, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.ObjectStore, error)
	List(opts v1.ListOptions) (*v1beta1.ObjectStoreList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ObjectStore, err error)
...
func newObjectStores(c *CephV1beta1Client, namespace string) *objectStores {
	return &objectStores{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *objectStores) Get(name string, options v1.GetOptions) (result *v1beta1.ObjectStore, err error) {
	result = &v1beta1.ObjectStore{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *objectStores) List(opts v1.ListOptions) (result *v1beta1.ObjectStoreList, err error) {
	result = &v1beta1.ObjectStoreList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("objectstores").
...
func (c *objectStores) Create(objectStore *v1beta1.ObjectStore) (result *v1beta1.ObjectStore, err error) {
	result = &v1beta1.ObjectStore{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("objectstores").
...
func (c *objectStores) Update(objectStore *v1beta1.ObjectStore) (result *v1beta1.ObjectStore, err error) {
	result = &v1beta1.ObjectStore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectstores").
...
func (c *objectStores) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ObjectStore, err error) {
	result = &v1beta1.ObjectStore{}
