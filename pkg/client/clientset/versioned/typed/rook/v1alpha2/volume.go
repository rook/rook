...
type VolumeInterface interface {
	Create(*v1alpha2.Volume) (*v1alpha2.Volume, error)
	Update(*v1alpha2.Volume) (*v1alpha2.Volume, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.Volume, error)
	List(opts v1.ListOptions) (*v1alpha2.VolumeList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Volume, err error)
	VolumeExpansion
}
...
func (c *volumes) Get(name string, options v1.GetOptions) (result *v1alpha2.Volume, err error) {
...
func (c *volumes) List(opts v1.ListOptions) (result *v1alpha2.VolumeList, err error) {
...
func (c *volumes) Create(volume *v1alpha2.Volume) (result *v1alpha2.Volume, err error) {
	result = &v1alpha2.Volume{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("volumes").
...
func (c *volumes) Update(volume *v1alpha2.Volume) (result *v1alpha2.Volume, err error) {
	result = &v1alpha2.Volume{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("volumes").
...
func (c *volumes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Volume, err error) {
	result = &v1alpha2.Volume{}
