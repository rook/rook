...
type ISGWInterface interface {
	Create(*v1beta1.ISGW) (*v1beta1.ISGW, error)
	Update(*v1beta1.ISGW) (*v1beta1.ISGW, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.ISGW, error)
	List(opts v1.ListOptions) (*v1beta1.ISGWList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ISGW, err error)
	ISGWExpansion
}
...
func newISGWs(c *EdgefsV1beta1Client, namespace string) *iSGWs {
	return &iSGWs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *iSGWs) Get(name string, options v1.GetOptions) (result *v1beta1.ISGW, err error) {
	result = &v1beta1.ISGW{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("isgws").
...
func (c *iSGWs) List(opts v1.ListOptions) (result *v1beta1.ISGWList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ISGWList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("isgws").
...
func (c *iSGWs) Create(iSGW *v1beta1.ISGW) (result *v1beta1.ISGW, err error) {
	result = &v1beta1.ISGW{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("isgws").
...
func (c *iSGWs) Update(iSGW *v1beta1.ISGW) (result *v1beta1.ISGW, err error) {
	result = &v1beta1.ISGW{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("isgws").
...
func (c *iSGWs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ISGW, err error) {
	result = &v1beta1.ISGW{}
