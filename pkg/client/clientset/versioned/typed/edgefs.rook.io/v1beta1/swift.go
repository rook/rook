...
type SWIFTInterface interface {
	Create(*v1beta1.SWIFT) (*v1beta1.SWIFT, error)
	Update(*v1beta1.SWIFT) (*v1beta1.SWIFT, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.SWIFT, error)
	List(opts v1.ListOptions) (*v1beta1.SWIFTList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.SWIFT, err error)
	SWIFTExpansion
}
...
func newSWIFTs(c *EdgefsV1beta1Client, namespace string) *sWIFTs {
	return &sWIFTs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *sWIFTs) Get(name string, options v1.GetOptions) (result *v1beta1.SWIFT, err error) {
	result = &v1beta1.SWIFT{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("swifts").
		Name(name).
...
func (c *sWIFTs) List(opts v1.ListOptions) (result *v1beta1.SWIFTList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.SWIFTList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("swifts").
...
func (c *sWIFTs) Create(sWIFT *v1beta1.SWIFT) (result *v1beta1.SWIFT, err error) {
	result = &v1beta1.SWIFT{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("swifts").
...
func (c *sWIFTs) Update(sWIFT *v1beta1.SWIFT) (result *v1beta1.SWIFT, err error) {
	result = &v1beta1.SWIFT{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("swifts").
...
func (c *sWIFTs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.SWIFT, err error) {
	result = &v1beta1.SWIFT{}
