...
type Configuration struct {
	...
	// TODO
	//PreparedStatementsCacheSizeMb       interface{} `json:"prepared_statements_cache_size_mb"`
	//ThriftPreparedStatementsCacheSizeMb interface{} `json:"thrift_prepared_statements_cache_size_mb"`
	//KeyCacheSizeInMb   interface{} `json:"key_cache_size_in_mb"`
	...
	//CounterCacheSizeInMb                interface{} `json:"counter_cache_size_in_mb"`
	...
	//IndexSummaryCapacityInMb            interface{} `json:"index_summary_capacity_in_mb"`
