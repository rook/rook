...
func TestStartSecureDashboard(t *testing.T) {
	...
	executor.MockExecuteCommandWithOutputFileTimeout = func(debug bool, timeout time.Duration, command, outfileArg string, arg ...string) (string, error) {
		return executor.MockExecuteCommandWithOutputFile(debug, command, outfileArg, arg...)
	}
