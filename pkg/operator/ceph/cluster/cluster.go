...
func newCluster(ctx context.Context, c *cephv1.CephCluster, context *clusterd.Context, ownerInfo *k8sutil.OwnerInfo, operatorContext context.Context, rookImage string) *cluster {
	return &cluster{
