...
const (
	...
	wipeDeviceFromOtherClustersVarName  = "ROOK_WIPE_DEVICE_FROM_OTHER_CLUSTERS"
)
...
func wipeDeviceFromOtherClustersEnvVar(wipeDevice string) v1.EnvVar {
	return v1.EnvVar{Name: wipeDeviceFromOtherClustersVarName, Value: wipeDevice}
}
