...
func (c *Cluster) startOSDMigration() (*migrationConfig, error) {
	...
	if c.spec.Storage.Migration.Confirmation != OSDMigrationCofirmation || c.spec.Storage.Store.UpdateStore != OSDUpdateStoreConfirmation {
		logger.Debug("no OSD migration is requested")
		return nil, nil
	}
	logger.Info("osd is migration is requested")
