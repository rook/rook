...
func TestGenerateClientProfileMappings(t *testing.T) {
	...
	assert.Equal(t, "1", clientProfile.Spec.Mappings[0].BlockPoolIdMapping["2"])
}
...
func TestGenerateClientProfileMappingsWithMultiplePeers(t *testing.T) {
	...
	assert.Equal(t, "1", clientProfile.Spec.Mappings[1].BlockPoolIdMapping["3"])
	...
	assert.Equal(t, "1", clientProfile.Spec.Mappings[2].BlockPoolIdMapping["4"])
}
