...
func Test_setObjPropertyIfExists(t *testing.T) {
	type args struct {
		json string
		val  string
		path []string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := json.Unmarshal([]byte(tt.args.json), &obj)
			assert.NoError(t, err)
			prev, err := setObjPropertyIfExists(obj, tt.args.val, tt.args.path...)
			if tt.wantErr {
				assert.Error(t, err)
				return
			} else {
...
func Test_setObjPropertyObjIfExists(t *testing.T) {
	type args struct {
		json string
		val  map[string]interface{}
		path []string
...
func Test_setObjPropertyArrIfExists(t *testing.T) {
	type args struct {
		json string
		val  []interface{}
		path []string
