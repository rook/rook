...
func (c *clusterConfig) makeDaemonContainer(rgwConfig *rgwConfig) (v1.Container, error) {
	...
	container := v1.Container{
		...
		Args: append(
			...
			cephconfig.NewFlag("crush location", fmt.Sprintf("%s=%s", "host", controller.ContainerEnvVarReference(k8sutil.NodeNameEnvVar))),
			// cephconfig.NewFlag("host", controller.ContainerEnvVarReference(k8sutil.NodeNameEnvVar)),
