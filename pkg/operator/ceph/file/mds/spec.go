...
func (c *Cluster) makeDeployment(mdsConfig *mdsConfig, namespace string) (*apps.Deployment, error) {
	...
	podSpec := v1.PodTemplateSpec{
		...
		Spec: v1.PodSpec{
			...
			Volumes:           controller.DaemonVolumes(mdsConfig.DataPathMap, mdsConfig.ResourceName, c.clusterSpec.DataDirHostPath, false),
...
func (c *Cluster) makeChownInitContainer(mdsConfig *mdsConfig) v1.Container {
	return controller.ChownCephDataDirsInitContainer(
		*mdsConfig.DataPathMap,
		...
		controller.DaemonVolumeMounts(mdsConfig.DataPathMap, mdsConfig.ResourceName, false),
...
func (c *Cluster) makeMdsDaemonContainer(mdsConfig *mdsConfig) v1.Container {
	...
	container := v1.Container{
		...
		VolumeMounts:    controller.DaemonVolumeMounts(mdsConfig.DataPathMap, mdsConfig.ResourceName, false),
