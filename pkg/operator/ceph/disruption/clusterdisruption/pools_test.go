			...
			Items: []cephv1.CephFilesystem{
				{
					...
					Spec: cephv1.FilesystemSpec{
						MetadataServer: cephv1.MetadataServerSpec{ActiveCount: 1, StandbyCount: 0, ActiveStandby: false},
					},
				},
			},
		}
			...
			Items: []cephv1.CephFilesystem{
				{
					ObjectMeta: metav1.ObjectMeta{Name: fsName, Namespace: ns},
					Spec: cephv1.FilesystemSpec{
						MetadataServer: cephv1.MetadataServerSpec{ActiveCount: 1, StandbyCount: 0, ActiveStandby: true},
					},
				},
			},
		}
			...
			Items: []cephv1.CephFilesystem{
				{
					ObjectMeta: metav1.ObjectMeta{Name: fsName, Namespace: ns},
					Spec: cephv1.FilesystemSpec{
						MetadataServer: cephv1.MetadataServerSpec{ActiveCount: 1, StandbyCount: 1, ActiveStandby: false},
					},
				},
			},
		}
