...
func TestSaveMonEndpoints(t *testing.T) {
	...
	configDir, _ := ioutil.TempDir("", "")
	defer os.RemoveAll(configDir)
	c := New(&clusterd.Context{Clientset: clientset, ConfigDir: configDir}, "ns", "", "myversion", 3, rookalpha.Placement{}, false, v1.ResourceRequirements{})
	c.clusterInfo = test.CreateConfigDir(1)
...
func TestAvailableMonNodes(t *testing.T) {
	clientset := test.New(1)
	c := New(&clusterd.Context{Clientset: clientset}, "ns", "", "myversion", 3, rookalpha.Placement{}, false, v1.ResourceRequirements{})
...
func TestGetNodeInfoFromNode(t *testing.T) {
	...
	c := New(&clusterd.Context{Clientset: clientset}, "ns", "", "myversion", 3, rookalpha.Placement{}, true, v1.ResourceRequirements{})
	c.clusterInfo = test.CreateConfigDir(0)
...
func TestHostNetworkPortIncrease(t *testing.T) {
	...
	c := New(&clusterd.Context{
		Clientset: clientset,
		ConfigDir: configDir,
	}, "ns", "", "myversion", 3, rookalpha.Placement{}, true, v1.ResourceRequirements{})
	c.clusterInfo = test.CreateConfigDir(0)
