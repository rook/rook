...
func storeExists(context *clusterd.Context, store rookalpha.ObjectStore) (bool, error) {
...
func instanceName(store rookalpha.ObjectStore) string {
...
func getLabels(store rookalpha.ObjectStore) map[string]string {
