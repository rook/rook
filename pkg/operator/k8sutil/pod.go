...
// ClusterDaemonEnvVars returns the environment variables used by storage cluster daemons
...
// SetNodeAntiAffinityForPod assigns pod anti-affinity when the pod should not be co-located
