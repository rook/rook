...
// +kubebuilder:validation:XValidation:rule="((size(self.script) > 0) != (size(self.scriptBase64) > 0)) != (size(self.scriptURL) > 0)",message="Exactly one of script, scriptBase64, or scriptURL must be set"
