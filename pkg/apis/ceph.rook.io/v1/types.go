...
type MirroringSpec struct {
	...
	// Mode is the mirroring mode: pool, image or init-only. Refer to [mirroring doc](https://docs.ceph.com/en/latest/rbd/rbd-mirroring/#enable-mirroring)
...
type RadosNamespaceMirroring struct {
	...
	// Mode is the mirroring mode; either pool or image. Refer to [namespace mirroring doc](https://docs.ceph.com/en/latest/rbd/rbd-mirroring/#namespace-configuration)
