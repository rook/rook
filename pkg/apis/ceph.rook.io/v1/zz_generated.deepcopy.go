		...
		*out = make(AnnotationsSpec, len(*in))
		for key, val := range *in {
			...
			if val == nil {
				...
				in, out := &val, &outVal
				*out = make(rookio.Annotations, len(*in))
				for key, val := range *in {
					(*out)[key] = val
				}
			}
...
func (in *CephClusterHealthCheckSpec) DeepCopyInto(out *CephClusterHealthCheckSpec) {
	*out = *in
	...
	if in.LivenessProbe != nil {
		in, out := &in.LivenessProbe, &out.LivenessProbe
		*out = make(map[rookio.KeyType]*ProbeSpec, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenPolicyAgentServiceSpec) DeepCopyInto(out *OpenPolicyAgentServiceSpec) {
	*out = *in
	if in.VerifySSL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenPolicyAgentServiceSpec.
func (in *OpenPolicyAgentServiceSpec) DeepCopy() *OpenPolicyAgentServiceSpec {
	if in == nil {
		return nil
	}
	out := new(OpenPolicyAgentServiceSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecuritySpec) DeepCopyInto(out *SecuritySpec) {
	*out = *in
	...
	if in.OpenPolicyAgentService != nil {
		in, out := &in.OpenPolicyAgentService, &out.OpenPolicyAgentService
		*out = new(OpenPolicyAgentServiceSpec)
		(*in).DeepCopyInto(*out)
	}
	return
