...
func (in *CephBucketNotification) DeepCopyInto(out *CephBucketNotification) {
	*out = *in
	...
	if in.Status != nil {
		in, out := &in.Status, &out.Status
		*out = new(CephBucketNotificationStatus)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CephBucketNotificationStatus) DeepCopyInto(out *CephBucketNotificationStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CephBucketNotificationStatus.
func (in *CephBucketNotificationStatus) DeepCopy() *CephBucketNotificationStatus {
	if in == nil {
		return nil
	}
	out := new(CephBucketNotificationStatus)
