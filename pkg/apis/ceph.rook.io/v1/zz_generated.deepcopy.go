...
func (in *ClusterStatus) DeepCopyInto(out *ClusterStatus) {
	*out = *in
	if in.Condition != nil {
		...
		*out = make([]RookConditions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RookConditions) DeepCopyInto(out *RookConditions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RookConditions.
func (in *RookConditions) DeepCopy() *RookConditions {
	if in == nil {
		return nil
	}
	out := new(RookConditions)
	in.DeepCopyInto(out)
	return out
}
