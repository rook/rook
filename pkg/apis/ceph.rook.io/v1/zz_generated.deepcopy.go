...
func (in *CephFilesystemStatus) DeepCopyInto(out *CephFilesystemStatus) {
	*out = *in
	...
	if in.PerfStats != nil {
		in, out := &in.PerfStats, &out.PerfStats
		*out = new(FilesystemStatsSpec)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilesystemClient) DeepCopyInto(out *FilesystemClient) {
	*out = *in
	if in.ValidMetrics != nil {
		in, out := &in.ValidMetrics, &out.ValidMetrics
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilesystemClient.
func (in *FilesystemClient) DeepCopy() *FilesystemClient {
	if in == nil {
		return nil
	}
	out := new(FilesystemClient)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilesystemMetrics) DeepCopyInto(out *FilesystemMetrics) {
	*out = *in
	if in.DelayedRanks != nil {
		in, out := &in.DelayedRanks, &out.DelayedRanks
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.MetadataServer != nil {
		in, out := &in.MetadataServer, &out.MetadataServer
		*out = make(map[string]MetadataServerList, len(*in))
		for key, val := range *in {
			var outVal map[string]string
			if val == nil {
				(*out)[key] = nil
				...
				in, out := &val, &outVal
				*out = make(MetadataServerList, len(*in))
				for key, val := range *in {
					(*out)[key] = val
				}
			}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilesystemMetrics.
func (in *FilesystemMetrics) DeepCopy() *FilesystemMetrics {
	if in == nil {
		return nil
	}
	out := new(FilesystemMetrics)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilesystemStats) DeepCopyInto(out *FilesystemStats) {
	*out = *in
	if in.GlobalCounters != nil {
		in, out := &in.GlobalCounters, &out.GlobalCounters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.Counters != nil {
	...
	if in.ClientMetadata != nil {
		...
		*out = make(map[string]FilesystemClient, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	if in.GlobalMetrics != nil {
		in, out := &in.GlobalMetrics, &out.GlobalMetrics
		*out = make(map[string]GlobalMetricsSpec, len(*in))
		for key, val := range *in {
			var outVal [][]int
			if val == nil {
				(*out)[key] = nil
				...
				in, out := &val, &outVal
				*out = make(GlobalMetricsSpec, len(*in))
				for i := range *in {
					if (*in)[i] != nil {
						in, out := &(*in)[i], &(*out)[i]
						*out = make([]int, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilesystemStats.
func (in *FilesystemStats) DeepCopy() *FilesystemStats {
	if in == nil {
		return nil
	}
	out := new(FilesystemStats)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilesystemStatsSpec) DeepCopyInto(out *FilesystemStatsSpec) {
	*out = *in
	if in.FilesystemStats != nil {
		in, out := &in.FilesystemStats, &out.FilesystemStats
		*out = new(FilesystemStats)
		(*in).DeepCopyInto(*out)
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilesystemStatsSpec.
func (in *FilesystemStatsSpec) DeepCopy() *FilesystemStatsSpec {
	if in == nil {
		return nil
	}
	out := new(FilesystemStatsSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in MetadataServerList) DeepCopyInto(out *MetadataServerList) {
	{
		in := &in
		*out = make(MetadataServerList, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataServerList.
func (in MetadataServerList) DeepCopy() MetadataServerList {
	if in == nil {
		return nil
	}
	out := new(MetadataServerList)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *NFSGaneshaSpec) DeepCopyInto(out *NFSGaneshaSpec) {
	*out = *in
	in.RADOS.DeepCopyInto(&out.RADOS)
