...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkFileSystemSpec) DeepCopyInto(out *NetworkFileSystemSpec) {
	*out = *in
	if in.Exports != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkFileSystemSpec.
func (in *NetworkFileSystemSpec) DeepCopy() *NetworkFileSystemSpec {
	if in == nil {
		return nil
	}
	out := new(NetworkFileSystemSpec)
	in.DeepCopyInto(out)
	return out
}
