...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GrowthPolicy) DeepCopyInto(out *GrowthPolicy) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GrowthPolicy.
func (in *GrowthPolicy) DeepCopy() *GrowthPolicy {
	if in == nil {
		return nil
	}
	out := new(GrowthPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StorageClassDeviceSet) DeepCopyInto(out *StorageClassDeviceSet) {
	*out = *in
	...
	if in.GrowthPolicy != nil {
		in, out := &in.GrowthPolicy, &out.GrowthPolicy
		*out = new(GrowthPolicy)
		**out = **in
	}
	return
