...
func (p PlacementSpec) GetAPI() Placement { return p.All.Merge(p.API) }

// GetMgr returns the placement for the MGR service
func (p PlacementSpec) GetMgr() Placement { return p.All.Merge(p.Mgr) }

// GetMon returns the placement for the MON service
func (p PlacementSpec) GetMon() Placement { return p.All.Merge(p.Mon) }

// GetOSD returns the placement for the OSD service
func (p PlacementSpec) GetOSD() Placement { return p.All.Merge(p.OSD) }
