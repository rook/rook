...
// ConvertLegacyPlacement takes a legacy rookv1alpha1 Placement object and converts it to a current
// rookv1alpha2 Placement object.
func ConvertLegacyPlacement(legacyPlacement rookv1alpha1.Placement) Placement {
	...
	if len(legacyPlacement.Tolerations) > 0 {
		p.Tolerations = make([]v1.Toleration, len(legacyPlacement.Tolerations))
