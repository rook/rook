...
.PHONY: helm.lint
helm.lint: $(HELM) ## Check the helm charts
	PATH="$(TOOLS_HOST_DIR):$$PATH" ct lint --charts=./deploy/charts/rook-ceph,./deploy/charts/rook-ceph-cluster --validate-yaml=false --validate-maintainers=false
