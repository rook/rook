...
echo $(kubectl auth can-i  "certificatesigningrequests.certificates.k8s.io" "*"  "*" --as=system:serviceaccount:rook-ceph:rook-ceph-system -n rook-ceph)
echo $(kubectl get clusterroles -n rook-ceph)
