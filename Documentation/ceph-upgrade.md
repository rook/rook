...
example, when Rook v1.5.12 is released, the process of updating from v1.5.0 is as simple as running
the following:
...
the version `v1.5.12`. This upgrade should work from any official patch release of Rook v1.4 to any
...
```sh
kubectl -n $ROOK_OPERATOR_NAMESPACE set image deploy/rook-ceph-operator rook-ceph-operator=rook/ceph:v1.5.12
```
...
deployments report `1/1/1` availability and `rook-version=v1.5.12`, the Ceph cluster's core
...
rook-ceph-mon-a         req/upd/avl: 1/1/1      rook-version=v1.5.12
rook-ceph-mon-b         req/upd/avl: 1/1/1      rook-version=v1.5.12
rook-ceph-mon-c         req/upd/avl: 1/1/1      rook-version=v1.5.12
rook-ceph-osd-0         req/upd/avl: 1//        rook-version=v1.5.12
...
At this point, your Rook operator should be running version `rook/ceph:v1.5.12`.
