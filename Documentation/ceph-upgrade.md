...
example, when Rook v1.6.11 is released, the process of updating from v1.6.0 is as simple as running
the following:
...
the version `v1.6.11`. This upgrade should work from any official patch release of Rook v1.5 to any
...
deployments report `1/1/1` availability and `rook-version=v1.6.11`, the Ceph cluster's core
