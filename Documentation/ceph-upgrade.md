...
another are as simple as updating the image of the Rook operator. For example, when Rook v1.4.9 is
released, the process of updating from v1.4.x is as simple as running the following:
...
the version `v1.4.9`. This upgrade should work from any official patch release of Rook v1.3 to any
...
deployments report `1/1/1` availability and `rook-version=v1.4.9`, the Ceph cluster's core
