...
| `csi.attacher.repository` | Kubernetes CSI Attacher image repository | `""` |
| `csi.attacher.tag` | Attacher image tag | `""` |
| `csi.cephcsi.repository` | Ceph CSI image repository | `""` |
| `csi.cephcsi.tag` | Ceph CSI image tag | `""` |
| `csi.csiAddons.repository` | CSIAddons sidecar image repository | `""` |
| `csi.csiAddons.tag` | CSIAddons sidecar image tag | `""` |
| `csi.installCsiOperator` | When true, install the ceph-csi-operator subchart (see Chart.yaml `condition`). | `true` |
| `csi.provisioner.repository` | Kubernetes CSI provisioner image repository | `""` |
| `csi.provisioner.tag` | Provisioner image tag | `""` |
| `csi.registrar.repository` | Kubernetes CSI registrar image repository | `""` |
| `csi.registrar.tag` | Registrar image tag | `""` |
| `csi.resizer.repository` | Kubernetes CSI resizer image repository | `""` |
| `csi.resizer.tag` | Resizer image tag | `""` |
...
| `csi.snapshotter.repository` | Kubernetes CSI snapshotter image repository | `""` |
| `csi.snapshotter.tag` | Snapshotter image tag | `""` |
