...
| `csi.registrar.image`               | Kubernetes CSI registrar image.                                                                                                                  | `registry.k8s.io/sig-storage/csi-node-driver-registrar:v2.5.0` |
...
| `csi.snapshotter.image`             | Kubernetes CSI snapshotter image.                                                                                                                | `registry.k8s.io/sig-storage/csi-snapshotter:v5.0.1`           |
...
| `csi.nfs.image`                     | NFS nodeplugin image.                                                                                                                            | `registry.k8s.io/sig-storage/nfsplugin:v3.1.0`                 |
