...
```console
kubectl create -f https://raw.githubusercontent.com/coreos/prometheus-operator/v0.81.0/bundle.yaml
```
...
kubectl delete -f https://raw.githubusercontent.com/coreos/prometheus-operator/v0.81.0/bundle.yaml
```
