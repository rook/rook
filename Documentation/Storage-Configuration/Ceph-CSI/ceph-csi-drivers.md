...
[here](https://github.com/ceph/ceph-csi/blob/v3.16.3/docs/rbd/deploy.md#encryption-for-rbd-volumes),
which includes a full list of supported encryption configurations.
More details on encrypting CephFS PVCs can be found [here](https://github.com/ceph/ceph-csi/blob/v3.16.3/docs/cephfs/deploy.md#cephfs-volume-encryption).
A sample KMS configmap can be found [here](https://github.com/ceph/ceph-csi/blob/v3.16.3/examples/kms/vault/kms-config.yaml).
