...
* (deprecated) `activeStandby`: Replaced by `standbyCount`.
  For backwards compatibility and upgradeability, this option remains supported when `standbyCount` is unset or set to 0.
