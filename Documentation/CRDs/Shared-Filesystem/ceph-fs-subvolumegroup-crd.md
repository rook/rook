...
## How to set a storage class **(*)** to consume CephFilesystemSubVolumeGroup
...
* Set the `clusterID` in the storage class (e.g, **(*)** `StorageClass`, `VolumeSnapshotClass` and `VolumeGroupSnapshotClass`) to this value instead of the name of the cluster namespace
