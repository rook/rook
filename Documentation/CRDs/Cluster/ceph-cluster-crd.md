...
* `cephVersion`: The version information for launching the ceph daemons.
    * `image`: The image used for running the ceph daemons. For example, `quay.io/ceph/ceph:v20.2.3`. For more details read the [container images section](#ceph-container-images).
...
| vRELNUM.Y.Z          | A specific release (e.g., v20.2.3)                        |
| vRELNUM.Y.Z-YYYYMMDD | A specific build (e.g., v20.2.3-20260804)                 |
