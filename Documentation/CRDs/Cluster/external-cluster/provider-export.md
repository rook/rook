...
* `--v2-port-enable`: (optional, **deprecated**) v2 mon port (3300) is now selected by default. This flag is ignored.
* `--v1-port-enable`: (optional) Use v1 mon port (6789) instead of the default v2 port (3300). Only required if your Ceph cluster does not support v2 (msgr2) protocol.
