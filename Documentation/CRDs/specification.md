...
<td>
<em>(Optional)</em>
<p>RgwReadAffinity defines the read affinity policy to optimize the read requests for the RGW clients
Note: Only supported for Ceph Tentacle (v20)</p>
</td>
</tr>
</tbody>
</table>
