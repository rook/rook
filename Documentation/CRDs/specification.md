...
<td>
<em>(Optional)</em>
<p>Store is the object store the account will be associated with</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>Name is the desired name of the RGW account if different from the CephObjectStoreAccount CR name.</p>
</td>
</tr>
<tr>
<td>
