...
Now, please refer to [https://rook.io/docs/rook/v1.0/development-flow.html](https://rook.io/docs/rook/v1.0/development-flow.html) to setup your development environment (go, git etc).
