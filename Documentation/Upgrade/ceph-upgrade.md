...
* Ceph Tentacle v20.2.0: Not recommended
    * IMPORTANT: **There is a known data corruption issue in v20.2.0**, if the "read affinity" feature is enabled.
    ...
    If read affinity is enabled in your cluster, upgrade to v20.2.3+.
...
* The most explicit form of tags are full-ceph-version-and-build tags (e.g., `v20.2.3-20260804`).
...
NEW_CEPH_IMAGE='quay.io/ceph/ceph:v20.2.3-20260804'
...
```console
kubectl -n rook-ceph set image deploy/rook-ceph-tools rook-ceph-tools=quay.io/ceph/ceph:v20.2.3-20260804
```
