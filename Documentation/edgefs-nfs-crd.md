---
title: EdgeFS Scale-Out, Multi-Cloud NFS
weight: 35
indent: true
---

# EdgeFS Scale-Out, Multi-Cloud NFS CRD
...
3. Create new local namespace (or we also call it "Region" or "Segment")

<pre>
efscli cluster create Hawaii
</pre>

4. Create logical tenants of cluster namespace "Hawaii", also buckets if needed
...
5. Create NFS service objects for tenants
...
At this point two NFS services should be available.
