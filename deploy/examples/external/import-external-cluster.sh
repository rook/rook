...
ROOK_EXTERNAL_CLUSTER_NAME=$NAMESPACE"-external"
...
OPERATOR_NAMESPACE=$NAMESPACE # default set to rook-ceph
...
CLUSTER_ID_RBD=$NAMESPACE"-external"
CLUSTER_ID_CEPHFS=$NAMESPACE"-external"
