...
For daemon keys (Rook creates at least 2 MDSes for each CephFilesystem):
...
3. Once reconciliation is nearing completion, CephFilesystem status is updated (example later)
