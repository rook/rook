...
For example, if you wanted to use `v1.6.7`, you would run `export KUBE_VERSION=v1.6.7` first before running `up`.

By default, the following versions of Kubernetes are used:
* `minikube.sh`: `v1.9.1`
* `kubeadm.sh`: `v1.8.5`
