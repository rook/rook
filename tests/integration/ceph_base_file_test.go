...
func fileSystemCSISnapshotTest(helper *clients.TestClient, k8sh *utils.K8sHelper, s *suite.Suite, storageClassName, namespace string, testNFS bool) {
	...
	// controller are removed as block test also installs CRD and controller.
	defer func() {
...
// Smoke Test for File System Storage - Test checks the following operations on Filesystem Storage in order
...
// cleanupFilesystem deletes the filesystem
