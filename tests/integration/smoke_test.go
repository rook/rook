...
func (suite *SmokeSuite) SetupSuite() {
	...
	mons := 3
	rbdMirrorWorkers := 1
	suite.op, suite.k8sh = StartTestCluster(suite.T, suite.namespace, "bluestore", true, false, useDevices, mons, rbdMirrorWorkers, installer.VersionMaster, installer.NautilusVersion)
