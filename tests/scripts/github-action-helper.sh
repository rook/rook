...
function create_helm_tag() {
  # on the prebuilt-image path this tag rode in the artifact tarball and was
  # imported into the cluster with the rest of it
  if [ -f _output/ci-image/rook-image.tar.zst ]; then
    return
  fi
