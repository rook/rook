          ...
          spec:
            ...
            properties:
              ...
              crushRoot:
                ...
                type: string
              deviceClass:
                description: 'The device class the OSD should set to (options are:
                  hdd, ssd, or nvme)'
                enum:
                - ssd
                - hdd
              ...
              replicated:
                ...
                properties:
                  replicasPerFailureDomain:
                    description: ReplicasPerFailureDomain the number of replica in
                      the specified failure domain
                    minimum: 1
                    type: integer
            ...
            type: object
          status:
            description: CephBlockPoolStatus represents the mirroring status of Ceph
              Storage Pool
            properties:
              info:
                additionalProperties:
            ...
            properties:
                ...
                properties:
                  ...
                  image:
                    description: Image is the container image used to launch the ceph
                      daemons, such as ceph/ceph:v15.2.9
                    type: string
                required:
                - image
                type: object
                    ...
                    additionalProperties:
                      ...
                      properties:
                        ...
                        probe:
                          ...
                          type: object
                      type: object
                    description: LivenessProbe allows to change the livenessprobe
              ...
              monitoring:
                ...
                properties:
                  ...
                  externalMgrPrometheusPort:
                    ...
                    type: integer
                  rulesNamespace:
                    description: RulesNamespace is the namespace where the prometheus
                      rules and alerts should be created. If empty, the same namespace
              ...
              storage:
                ...
                properties:
                  ...
                  volumeSources:
                    items:
                      description: VolumeSource is a volume source spec for Rook
                      properties:
                        config:
                          additionalProperties:
                            type: string
                          ...
                          x-kubernetes-preserve-unknown-fields: true
                        crushDeviceClass:
                          description: CrushDeviceClass represents the crush device
                            class for an OSD
                          type: string
                        encrypted:
                          description: Whether to encrypt the deviceSet
                          type: boolean
                        name:
                          description: Name is the name of the volume source
                          type: string
                        placement:
                          description: Placement is the placement for an object
                          nullable: true
                        ...
                        pvcSources:
                          additionalProperties:
                            ...
                            - claimName
                            type: object
                          description: PVCSources
                          type: object
                        resources:
                          description: Resources requests/limits for the devices
                          nullable: true
                          properties:
                            limits:
                              additionalProperties:
                        ...
                        schedulerName:
                          ...
                          type: string
                        size:
                          description: Size represents the size requested for the
                            PVC
                          type: string
                        tuneDeviceClass:
                          description: TuneSlowDeviceClass Tune the OSD when running
          ...
          spec:
            ...
            properties:
              ...
              labels:
                ...
                type: object
              placement:
                description: The affinity to place the rgw pods (default is to place
          ...
          spec:
            ...
            properties:
              dataPools:
                ...
                items:
                  ...
                  properties:
                    compressionMode:
                      default: none
                      description: 'The inline compression mode in Bluestore OSD to
                        set to (options are: none, passive, aggressive, force)'
                      enum:
                      - none
                      - passive
                      - aggressive
                    ...
                    crushRoot:
                      ...
                      type: string
                    deviceClass:
                      description: 'The device class the OSD should set to (options
                        are: hdd, ssd, or nvme)'
                      enum:
                      - ssd
                      - hdd
              ...
              metadataServer:
                ...
                properties:
                  activeCount:
                    description: The number of metadata servers that are active. The
                      remaining servers in the cluster will be in standby mode.
                    format: int32
                    maximum: 10
                    minimum: 1
                    type: integer
                  activeStandby:
                    description: Whether each active MDS instance will have an active
                      standby with a warm metadata cache for faster failover. If false,
                      standbys will still be available, but will not have a warm metadata
                      cache.
                    type: boolean
                  annotations:
                    additionalProperties:
                  ...
                  labels:
                    ...
                    x-kubernetes-preserve-unknown-fields: true
                  placement:
                    description: The affinity to place the mds pods (default is to
                      place on all available node) with a daemonset
                    nullable: true
                    properties:
                      nodeAffinity:
                        description: NodeAffinity is a group of node affinity scheduling
              ...
              preserveFilesystemOnDelete:
                description: Preserve the fs in the cluster on CephFilesystem CR deletion.
                  Setting this to true automatically implies PreservePoolsOnDelete
                  is true.
                type: boolean
          ...
          spec:
            ...
            properties:
              rados:
                ...
                properties:
                  namespace:
                    description: Namespace is the RADOS namespace where NFS client
                      recovery data is stored.
                    type: string
                  pool:
                    description: Pool is the RADOS pool where NFS client recovery
                      data is stored.
                    type: string
                required:
                - namespace
      ...
      openAPIV3Schema:
        ...
        properties:
          ...
          spec:
            ...
            properties:
              pull:
                description: PullSpec represents the pulling specification of a Ceph
                  Object Storage Gateway Realm
                properties:
                  endpoint:
                    type: string
                required:
              ...
              gateway:
                ...
                properties:
                  ...
                  externalRgwEndpoints:
                    ...
                    type: array
                  instances:
                    description: The number of pods in the rgw replicaset. If "allNodes"
                      is specified, a daemonset is created.
                    format: int32
                    minimum: 1
                    type: integer
                  labels:
...
spec:
  ...
  - name: v1
    schema:
      openAPIV3Schema:
        description: CephObjectZoneGroup represents a Ceph Object Store Gateway Zone
          Group
        properties:
          apiVersion:
            description: 'APIVersion defines the versioned schema of this representation
      ...
      openAPIV3Schema:
        ...
        properties:
          ...
          metadata:
            type: object
          spec:
            description: RBDMirroringSpec represents the specification of an RBD mirror
              daemon
            properties:
              annotations:
                additionalProperties:
                ...
                x-kubernetes-preserve-unknown-fields: true
              count:
                description: Count represents the number of rbd mirror instance to
                  run
                minimum: 1
                type: integer
              labels:
