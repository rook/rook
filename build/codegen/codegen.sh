...
cd "${scriptdir}/../../vendor/k8s.io/code-generator" && ./generate-groups.sh \
    ...
    "rook.io:v1alpha1,v1alpha2 ceph.rook.io:v1alpha1,v1beta1 cockroachdb.rook.io:v1alpha1 minio.rook.io:v1alpha1 nfs.rook.io:v1alpha1 cassandra.rook.io:v1alpha1"
