...
cd "${scriptdir}/../../vendor/k8s.io/code-generator" && ./generate-groups.sh \
    ...
    "rook.io:v1alpha2 ceph.rook.io:v1 cockroachdb.rook.io:v1alpha1 minio.rook.io:v1alpha1 nfs.rook.io:v1alpha1 cassandra.rook.io:v1alpha1 edgefs.rook.io:v1 yugabytedb.rook.io:v1alpha1 ozone.rook.io:v1alpha1"
