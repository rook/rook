...
func (b *AlertmanagerApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *AlertmanagerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *AlertmanagerApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *AlertmanagerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *AlertmanagerApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *AlertmanagerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
