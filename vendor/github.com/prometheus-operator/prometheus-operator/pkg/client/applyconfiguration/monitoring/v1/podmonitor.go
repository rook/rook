...
func (b *PodMonitorApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *PodMonitorApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *PodMonitorApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *PodMonitorApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *PodMonitorApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *PodMonitorApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *PodMonitorApplyConfiguration) WithStatus(value *ConfigResourceStatusApplyConfiguration) *PodMonitorApplyConfiguration {
	b.Status = value
	return b
}
