...
func (b *ServiceMonitorApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *ServiceMonitorApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ServiceMonitorApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *ServiceMonitorApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ServiceMonitorApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *ServiceMonitorApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
