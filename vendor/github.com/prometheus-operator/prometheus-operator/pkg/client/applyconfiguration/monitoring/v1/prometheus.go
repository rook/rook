...
func (b *PrometheusApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *PrometheusApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *PrometheusApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *PrometheusApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *PrometheusApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *PrometheusApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
