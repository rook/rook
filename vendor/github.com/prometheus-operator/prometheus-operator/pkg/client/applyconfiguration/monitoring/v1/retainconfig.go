...
// RetainConfigApplyConfiguration constructs a declarative configuration of the RetainConfig type for use with
// apply.
func RetainConfig() *RetainConfigApplyConfiguration {
	return &RetainConfigApplyConfiguration{}
}
...
func (b *RetainConfigApplyConfiguration) WithRetentionPeriod(value monitoringv1.Duration) *RetainConfigApplyConfiguration {
