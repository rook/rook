...
func (b *ProbeApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *ProbeApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ProbeApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *ProbeApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ProbeApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *ProbeApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
