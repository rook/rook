...
type ObjectbucketV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*ObjectbucketV1alpha1Client, error) {
	...
	return &ObjectbucketV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ObjectbucketV1alpha1Client for the given config and
...
func New(c rest.Interface) *ObjectbucketV1alpha1Client {
	return &ObjectbucketV1alpha1Client{c}
}
