...
type SharedInformerFactory interface {
	...
	Objectbucket() objectbucketio.Interface
}

func (f *sharedInformerFactory) Objectbucket() objectbucketio.Interface {
	return objectbucketio.New(f, f.namespace, f.tweakListOptions)
}
