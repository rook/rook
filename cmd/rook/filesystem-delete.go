...
func init() {
	filesystemDeleteCmd.Flags().StringVarP(&deleteFilesystemName, "name", "n", "", "Name of filesystem to delete (required)")

	filesystemDeleteCmd.MarkFlagRequired("name")
	filesystemDeleteCmd.RunE = deleteFilesystemEntry
}
