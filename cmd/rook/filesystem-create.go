...
func init() {
	filesystemCreateCmd.Flags().StringVarP(&newFilesystemName, "name", "n", "", "Name of new filesystem to create (required)")

	filesystemCreateCmd.MarkFlagRequired("name")
	filesystemCreateCmd.RunE = createFilesystemEntry
}
