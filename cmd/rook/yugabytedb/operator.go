...
import (
	...
	operator "github.com/rook/rook/pkg/operator/yugabytedb"
	"github.com/rook/rook/pkg/util/flags"
	"github.com/spf13/cobra"
)

const containerName = "rook-yugabytedb-operator"

var operatorCmd = &cobra.Command{
	Use:   "operator",
	Short: "Runs the yugabytedb operator to deploy and manage yugabytedb in kubernetes cluster.",
	Long: `Runs the yugabytedb operator to deploy and manage yugabytedb in kubernetes cluster.
...
func startOperator(cmd *cobra.Command, args []string) error {
	...
	logger.Infof("starting yugabytedb operator")
