...
const (
	...
	rookOperatorImagePodSpecTag    = "rook/rook:master-latest"
	rookToolsImagePodSpecTag       = "rook/toolbox:master-latest"
	rookOperatorPrefix             = "rook/rook"
	rookToolboxPrefix              = "rook/toolbox"
