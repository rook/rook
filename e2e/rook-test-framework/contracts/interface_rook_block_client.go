...
type Irook_block interface {
	...
	Block_Write(name string, mountpath string, data string, filename string, namespace string) (string, error)
	Block_Read(name string, mountpath string, filename string, namespace string) (string, error)
